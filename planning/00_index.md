...
| `ROADMAP.md` | the living roadmap: epics/stories, status, settled decisions D1–D6, questions Q1–Q8 (all closed), risk register, dependency-ordered execution sequence |
