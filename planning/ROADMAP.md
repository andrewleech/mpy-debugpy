...
- **STORY-6.7 — DAP interleaved with the REPL on a single UART**
  - **OPEN** — raised 2026-08-10 from a user correction; see D7 and
  ...
  - acceptance criteria:
    ...
    - [ ] a program that prints the marker byte does not desynchronise the
