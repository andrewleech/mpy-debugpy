...
- **Q14 → mirror both flags as launch-configuration keys, absent meaning
  ...
  `supportsRestartRequest` as an in-place restart. The second needs a real
  extension host, which has never run. Reasoning in
  `20260810_q14_f5_source_and_loop.md`.
...
11. **STORY-6.1** (needs 2.2,5.4), **STORY-6.2** (needs 5.4,EPIC-4) — parallel.
    ...
    is proven on the same board, and criterion 4 with it on 2026-08-10; it
...
16. **STORY-8.3** (needs 8.1,6.4), **STORY-8.4** (needs EPIC-5,6,3) — parallel.
    **STORY-8.4 DONE 2026-08-09**, and closing it closed STORY-6.3's second
    ...
    front of reviewers are the user's call. **Criterion 4 was reachable and was
    closed on 2026-08-10**, once "handled" was read as what a DAP client can
    actually be told rather than as ampremote's reconnect. **Q14 and Q11 were both reachable
